...
This OSS edition contains no cloud code, no telemetry, and no dependencies on any hosted MindMapVault services.

The OSS edition does not include analytics, telemetry, crash reporting, or any outbound network requests.
